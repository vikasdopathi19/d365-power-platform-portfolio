...
Build in Release mode; sign the assembly if your org requires strong naming.
Register with the Plugin Registration Tool:
...
Ensure a queue named Case Escalation Queue and the new_caseescalationlog entity exist in the target environment (see schema table above).
Running the tests
